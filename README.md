### Hello! I'm Parrot! Coding is (mostly) just a hobby of mine.
...
| **[CustomSounds](https://git.gay/TheBlackParrot/SRXD_CustomSounds)**                       | Changes the game sounds to sounds of your choosing                                      |
...
|----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|----------------------------------------------|
| **[AccuracyInResults](https://git.gay/TheBlackParrot/BS_AccuracyInResults)**                 | Replaces the rank text in the results screen with your accuracy                                                 | >= 1.39.1                                    |
| **[AnotherStatusSocket](https://git.gay/TheBlackParrot/BS_AnotherStatusSocket)**             | Provides a WebSocket interface for live game events                                                             | >= 1.40.8                                    |
| **[BeatLeaderStarRatingCache](https://git.gay/TheBlackParrot/BS_BeatLeaderStarRatingCache)** | Pulls BeatLeader's star rating Protobuf cache and exposes it for use in other mods                              | >= 1.40.8                                    |
...
| **[DisableLowPassAudioFilter](https://git.gay/TheBlackParrot/BS_DisableLowPassAudioFilter)** | Disables the low pass audio filter                                                                              | >= 1.29.1                                    |
| **[EfficientCoverImages](https://git.gay/TheBlackParrot/BS_EfficientCoverImages)**           | Shrinks cover images to speed up texture initialization                                                         | >= 1.39.1                                    |
...
| **[MuteTwitchVODTrack](https://git.gay/TheBlackParrot/BS_MuteTwitchVODTrack)**               | Toggles an audio track on an audio input source in OBS when selecting maps in the menu                          | >= 1.40.8                                    |
| **[NoteTweaks](https://git.gay/TheBlackParrot/BS_NoteTweaks)**                               | Change various aspects of the default Beat Saber note                                                           | `0.11`: >= 1.40.8<br> `0.10`: >= 1.39.1<br> `0.9`: 1.29.1 - 1.37.1 |
| **[OfflineLeaderboard](https://git.gay/TheBlackParrot/BS_OfflineLeaderboard)**               | Keeps track of scores locally and displays them in the leaderboard area of the Solo menu                        | >= 1.40.8                                    |
| **[PlayAlong](https://git.gay/TheBlackParrot/BS_PlayAlong)**                                 | Passive multiplayer mod, intended to help synchronize gameplay between players                                  | >= 1.39.1                                    |
...
| **[QuickPlaylistToggles](https://git.gay/TheBlackParrot/BS_QuickPlaylistToggles)**           | Quickly toggle the actively selected map in specific playlists                                                  | >= 1.40.8                                    |
| **[SimpleSoundChanger](https://git.gay/TheBlackParrot/BS_SimpleSoundChanger)**               | Change some of Beat Saber's sound effects                                                                       | `0.1`: >= 1.40.8<br> `0.0`: >= 1.29.1        |
| **[SkipTheResults](https://git.gay/TheBlackParrot/BS_SkipTheResults)**                       | Skips the results screen after finishing a map                                                                  | >= 1.29.1                                    |
| **[VerboseVolume](https://git.gay/TheBlackParrot/BS_VerboseVolume)**                         | Volume manager with some extra specifics                                                                        | `0.1`: >= 1.39.1<br> `0.0`: >= 1.29.1        |
