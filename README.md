...
| **[MuteTwitchVODTrack](https://git.gay/TheBlackParrot/BS_MuteTwitchVODTrack)**               | Toggles an audio track on an audio input source in OBS when selecting maps in the menu                          | >= 1.44.0                                    |
